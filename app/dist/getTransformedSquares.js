...
function getTransformedSquares(source, size, transform, outputFileName) {
    ...
    const result = ImageInterface_1.default.blankImage(size, size);
...
exports.default = getTransformedSquares;
