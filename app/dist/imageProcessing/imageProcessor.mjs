...
const getTransformedSquares_1 = __importDefault(
  require("./getTransformedSquares")
);
const extractBoxes_1 = require("./extractBoxes");
const predictDigits_1 = __importDefault(
  require("../digitsRecognition/predictDigits")
);
async function processor(imageObject) {
  ...
  const largestBlob = (0, largestObjectLocalisation_1.getLargestBlob)(
    thresholded,
    {
      minAspectRatio: 0.5,
      maxAspectRatio: 1.5,
  ...
  if (largestBlob) {
    ...
    if ((0, sanityCheck_1.default)(cornerPoints)) {
      ...
      const transform = (0, homographicTransform_1.homographicTransform)(
        PROCESSING_SIZE,
        cornerPoints
      );
      const gridLines = (0, createGridLines_1.default)(
        transform,
        PROCESSING_SIZE
      );
      thresholded.drawGridLines(gridLines, imageObject.data, "gridLines.png");
      const extractedGrayscaleImage = (0, getTransformedSquares_1.default)(
        grayscaleImg,
        PROCESSING_SIZE,
        transform,
        "greyscaleExtracted.png"
      );
      const extractedThresholdImage = (0, getTransformedSquares_1.default)(
        thresholded,
        PROCESSING_SIZE,
        transform,
        "thresholdExtracted.png"
      );
      const boxes = (0, extractBoxes_1.extractSudokuBoxes)(
...
//# sourceMappingURL=imageProcessor.mjs.map
